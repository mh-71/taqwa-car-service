...
const SeedData = (() => {
  ...
  function load(db) {
    ...
    const appointments = [
      ...
      { id: 'APT-0003', customerId: 'CUS-0004', vehicleId: 'VEH-0004', serviceId: 'SRV-0010', date: dateOnly(0),  time: '09:00', duration: 120, mechanicId: 'MEC-0001', complaint: 'Full check before long trip', notes: 'Arrived on time', status: 'Confirmed', reminderSent: true, jobCardId: 'JOB-0004', source: 'Facebook', createdAt: iso(4) },
